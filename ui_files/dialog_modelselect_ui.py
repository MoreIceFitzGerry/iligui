...
"}")
        ...
        self.horizontalLayout = QtWidgets.QHBoxLayout(self.queryFrame)
        ...
        self.toolButton = QtWidgets.QToolButton(parent=self.queryFrame)
        icon1 = QtGui.QIcon()
...
"")
        ...
        self.loadingLabel.setPixmap(QtGui.QPixmap("c:\\Users\\mauri\\Repos\\GitHub\\iligui\\ui_files\\../icons/Spin-1s-200px.gif"))
    ...
    def retranslateUi(self, modelselectDialog):
        ...
        self.lineEdit.setText(_translate("modelselectDialog", "Enter Model Link"))
        self.lineEdit.setPlaceholderText(_translate("modelselectDialog", "Enter Model Name"))
        self.toolButton.setText(_translate("modelselectDialog", "..."))
