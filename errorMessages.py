...
err_compositionType_UnorderedExtOrdered="""A BAG (unordered) can not extend a LIST (ordered)."""
err_compositionType_componentNotExt="""For extending the composition, {0} would have to extend {1}."""
err_compositionType_cardExtMismatch="""An attribute with cardinality {0} can not extend one whose cardinality is {1}. The cardinality must be more restrictive."""
...
err_uniqueness_attrCardinality="""unexpected cardinality of attribute "{0}"."""
err_uniqueness_roleCardinality="""unexpected cardinality of role "{0}"."""
